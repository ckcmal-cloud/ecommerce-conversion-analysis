-- =========================================================================
-- 01_user_event_table.sql
-- 목적: 원천 로그 데이터(nail_market)의 시간 데이터를 정제하고 타임존을 변환하여
--       분석에 용이한 유저 이벤트 기준 테이블(user_event_table)을 구축합니다.
-- 유래: 02_ecommerce_behavior_analysis.ipynb의 "데이터 로드" 전처리 파트
-- =========================================================================
